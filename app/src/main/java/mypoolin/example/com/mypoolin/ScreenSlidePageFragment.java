...
public class ScreenSlidePageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mParam1.equalsIgnoreCase("girl"))
            v.setBackgroundDrawable(getResources().getDrawable(R.drawable.girl));
        else
            v.setBackgroundDrawable(getResources().getDrawable(R.drawable.geek));
